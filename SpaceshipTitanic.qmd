...
1. Positive coefficients mean increased likelihood for larger values of predictor

2. For categorical variables, e^Bi gives the odds of belonging to "class 1"

3. marginal effects for numeric variables
